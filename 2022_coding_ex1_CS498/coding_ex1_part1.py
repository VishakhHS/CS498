...
class OdometryNode(Node):
    ...
    def timer_callback_odom(self):
        ...
        vr = None  # ... Your code here. Average right-wheels speed
        
        v = None # ... Linear velocity of the robot
        w = None # ... Angular velocity of the robot
        self.x = None # ...Position
        self.y = None # ...Position
        ...
        # odom.pose.pose.position.x = None # ...
        # odom.pose.pose.position.y = None # ...
        # odom.pose.pose.position.z = None # ... 
        # odom.pose.pose.orientation.x = quater[0]
        # odom.pose.pose.orientation.y = None # ...
        # odom.pose.pose.orientation.z = None # ...
        # odom.pose.pose.orientation.w = None # ...

        # set the velocities. Uncomment next lines
        # odom.child_frame_id = child_frame_id
        # odom.twist.twist.linear.x = None # ...
        # odom.twist.twist.linear.y = None # ...
        # odom.twist.twist.linear.z = None # ...
        # odom.twist.twist.angular.x = None # ...
        # odom.twist.twist.angular.y = None # ...
        # odom.twist.twist.angular.z = None # ...
    ...
    def broadcast_tf(self, pos, quater, frame_id, child_frame_id):
        ...
        # t.transform.translation.x = None # ...
        # t.transform.translation.y = None # ...
        # t.transform.translation.z = None # ...

        # t.transform.rotation.x = None # ...
        # t.transform.rotation.y = None # ...
        # t.transform.rotation.z = None # ...
        # t.transform.rotation.w = None # ...
